...
DROP DATABASE IF EXISTS card_flowable;
CREATE DATABASE IF NOT EXISTS card_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS card_medical;
CREATE DATABASE IF NOT EXISTS card_medical DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
